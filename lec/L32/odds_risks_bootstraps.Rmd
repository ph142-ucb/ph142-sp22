...
### Parting humor, courtesy of [irregular webcomic](http://irregularwebcomic.net/2653.html)

```{r parting, fig.align='center', out.width="85%", echo=FALSE }
knitr::include_graphics("bynumbers.png")
```
