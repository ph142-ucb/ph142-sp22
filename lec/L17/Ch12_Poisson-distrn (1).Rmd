---
title: 'Chapter 12: The Poisson distribution'
...
event in fixed, finite intervals of time or space when:
  ...
  occurred does not change the probability that another event may occur. And,
  2. The probability of an occurrence is the same over all possible intervals of
  the same size.
  
This count is denoted by the random variable $X$. $X$ is a count, so it can take
