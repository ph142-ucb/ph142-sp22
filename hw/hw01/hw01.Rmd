...
```{r}
sleep_sl <- NULL # YOUR CHOICE HERE
sleep_sl
...
```{r}
sleep_over16 <- NULL # YOUR CHOICE HERE
sleep_over16
...
```{r}
sleep_mammals <- NULL # YOUR CHOICE HERE
sleep_mammals
...
```{r}
sleep_hg <- NULL # YOUR CHOICE HERE
sleep_hg
...
```{r}
sleep_time <- NULL # YOUR CHOICE HERE
sleep_time
...
```{r}
sleep_rev <- NULL # YOUR CHOICE HERE
sleep_rev
...
```{r}
sleep_time_rev <- NULL # YOUR CHOICE HERE
sleep_time_rev
...
```{r}
sleep_ratio <- NULL # YOUR CHOICE HERE
sleep_ratio
...
```{r}
sleep_bw <- NULL # YOUR CHOICE HERE
sleep_bw
...
```{r}
avg_sleep_time <- NULL # YOUR CHOICE HERE
avg_sleep_time
...
```{r}
avg_by_vore <- NULL # YOUR CHOICE HERE
avg_by_vore
